...
-- *********************************************************************
-- Change Log: src/main/resources/db/changelog-4.1.3.xml
-- Ran at: 2/10/20 1:23 PM
-- Against: null@offline:oracle?version=11.2.0&changeLogFile=/home/cosmin/IdeaProjects/domibus/Domibus-MSH-db/target/liquibase/changelog-4.1.3.oracle
-- Liquibase version: 3.5.3
-- *********************************************************************


-- Changeset src/main/resources/db/changelog-4.1.3.xml::changelog-3.2-delta-1::martifp
-- create sequence
...
-- Changeset src/main/resources/db/changelog-4.1.3.xml::1564477107969-13::Catalin Enache
...
CREATE TABLE TB_PARTY_ID (ID_PK NUMBER(38, 0) NOT NULL, TYPE VARCHAR2(255), VALUE VARCHAR2(255), TO_ID NUMBER(38, 0), FROM_ID NUMBER(38, 0), CONSTRAINT PK_TB_PARTY_ID PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_PROPERTY (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255) NOT NULL, VALUE VARCHAR2(255), MESSAGEPROPERTIES_ID NUMBER(38, 0), PARTPROPERTIES_ID NUMBER(38, 0), TYPE VARCHAR2(255), CONSTRAINT PK_TB_PROPERTY PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_SIGNAL_MESSAGE (ID_PK NUMBER(38, 0) NOT NULL, PULL_REQUEST_MPC VARCHAR2(255), MESSAGEINFO_ID_PK NUMBER(38, 0), RECEIPT_ID_PK NUMBER(38, 0), CONSTRAINT PK_TB_SIGNAL_MESSAGE PRIMARY KEY (ID_PK));
...
-- Changeset src/main/resources/db/changelog-4.1.3.xml::1564477107969-95::Catalin Enache
...
-- Changeset src/main/resources/db/changelog-4.1.3.xml::1564477107969-104::Catalin Enache
-- create indexes
...
-- Changeset src/main/resources/db/changelog-4.1.3.xml::1564477107969-234::Catalin Enache
-- create foreign keys
...
-- Changeset src/main/resources/db/changelog-4.1.3.xml::1564477107969-325::Catalin Enache
-- create AUDIT views
...
-- Changeset src/main/resources/db/changelog-4.1.3.xml::EDELIVERY-3361-1::CatalinEnache
...
-- Changeset src/main/resources/db/changelog-4.1.3.xml::EDELIVERY-2144_1::thomas dussart
