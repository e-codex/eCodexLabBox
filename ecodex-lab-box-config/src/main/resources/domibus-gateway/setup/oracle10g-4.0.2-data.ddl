...
-- *********************************************************************
-- Change Log: src/main/resources/db/changelog-4.0.2-data.xml
-- Ran at: 11/02/19 09:20
-- Against: null@offline:oracle?version=11.2.0&changeLogFile=C:\Users\baciuco\workspace\domibus\Domibus-MSH-db\target/liquibase/changelog-4.0.2-data.oracle
...
INSERT INTO TB_AUTHENTICATION_ENTRY (ID_PK, USERNAME, PASSWD, AUTH_ROLES) VALUES (HIBERNATE_SEQUENCE.nextval, 'admin', '$2a$10$5uKS72xK2ArGDgb2CwjYnOzQcOmB7CPxK6fz2MGcDBM9vJ4rUql36', 'ROLE_ADMIN');

INSERT INTO TB_AUTHENTICATION_ENTRY (ID_PK, USERNAME, PASSWD, AUTH_ROLES, ORIGINAL_USER) VALUES (HIBERNATE_SEQUENCE.nextval, 'user', '$2a$10$HApapHvDStTEwjjneMCvxuqUKVyycXZRfXMwjU0rRmaWMsjWQp/Zu', 'ROLE_USER', 'urn:oasis:names:tc:ebcore:partyid-type:unregistered:C1');
