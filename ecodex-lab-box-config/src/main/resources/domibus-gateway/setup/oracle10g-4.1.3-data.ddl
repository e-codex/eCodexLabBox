...
-- *********************************************************************
-- Change Log: src/main/resources/db/changelog-4.1.3-data.xml
-- Ran at: 2/10/20 1:23 PM
-- Against: null@offline:oracle?version=11.2.0&changeLogFile=/home/cosmin/IdeaProjects/domibus/Domibus-MSH-db/target/liquibase/changelog-4.1.3-data.oracle
-- Liquibase version: 3.5.3
-- *********************************************************************


-- Changeset src/main/resources/db/changelog-4.1.3-data.xml::EDELIVERY-2144::thomas dussart
-- inserts
...
-- Changeset src/main/resources/db/changelog-4.1.3-data.xml::insert_ws_default_auth::idragusa
