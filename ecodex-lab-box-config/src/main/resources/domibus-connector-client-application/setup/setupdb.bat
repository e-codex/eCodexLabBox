...
java -cp ${project.basedir}\labenv${lab.id}\domibus-connector-client-application\lib\h2.jar org.h2.tools.RunScript -url jdbc:h2:file:${project.basedir}\labenv${lab.id}\domibus-connector-client-application\database\connector-client-h2-db;MODE=Oracle -user connectorclient -password connectorclient -script ${project.basedir}\labenv${lab.id}\domibus-connector-client-application\setup\create_schema.sql
